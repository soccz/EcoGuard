...
- Keep core release verification and optional research verification separate: never add research tests, dependencies, metrics, or artifacts to the core's 174-test/wheel claims. Run the public-model and post-award reconstruction checks through their documented research environment and dedicated verifiers.
